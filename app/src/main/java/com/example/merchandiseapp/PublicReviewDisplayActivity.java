...
public class PublicReviewDisplayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_public_review_display);

        Category = getIntent().getStringExtra("category");
        productID = getIntent().getStringExtra("pid");
        GroupName = getIntent().getStringExtra("groupName");

        recyclerView = findViewById(R.id.recyclerReview_public);
        ...
        final Query queries = displayRef.orderByChild("IsPrivate").equalTo("No");
    ...
    private void DataExists(Query queries)
    {
                ...
                = new FirebaseRecyclerAdapter<Rating, reviewsViewHolder>(options)
        {
            ...
            protected void onBindViewHolder(@NonNull reviewsViewHolder holder, int position, @NonNull final Rating model)
            {
                ...
                holder.lstatus.setText("Public Reviews" );
            }
